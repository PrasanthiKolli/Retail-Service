...
class RetailerUtilTest {
    ...
    void testCalculatePointsLessThan50() {
        Long points = RetailerUtil.calculatePoints(new BigDecimal("40"));
        assertEquals(0, points);
    }
    @Test
    void testCalculatePointsBetween50And100() {
        Long points = RetailerUtil.calculatePoints(new BigDecimal("75"));
        // Expected: 75 - 50 = 25
    ...
    void testCalculatePointsExactly50() {
        Long points = RetailerUtil.calculatePoints(new BigDecimal("50"));
        // Expected: 50 - 50 = 0
        assertEquals(0, points);
    }
    ...
    void testCalculatePointsExactly100() {
        Long points = RetailerUtil.calculatePoints(new BigDecimal("100"));
        // Expected: 100 - 50 = 50
    ...
    void testCalculatePointsGreaterThan100() {
        Long points = RetailerUtil.calculatePoints(new BigDecimal("120"));
